...
export namespace ExpoRouter {
  type StaticRoutes = `/` | `/(tabs)` | `/(tabs)\` | `/..\app-example\(tabs)\` | `/..\app-example\(tabs)\explore` | `/..\app-example\+html` | `/..\app-example\+not-found` | `/..\app-example\_layout` | `/..\components\navigation\TabBarIcon` | `/_sitemap`;
